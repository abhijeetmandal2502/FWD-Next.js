...
const CreatePost = () => {
  ...
  const token = session?.user?.data?.jwt;

  //   console.log('checksession', token);

  //   const [opstCreateDatamsetPostCreateData]=[{''}]
  ...
  const removePost = (index) => {
    ...
    var tempArr = postCount;

    tempArr.splice(index, 1);
    console.log('temparr :', tempArr);

    setPostCount(tempArr);
    // console.log('postCount', postCount);
  };

  const createPostAPI = async () => {
    // await fetch('https://fwd.thenwg.xyz/api/create-post.php',
    // );
    ...
    await fetch(url, {
      ...
      .then((response) => {
        ...
        console.log('checkpost 2', response);
      })
      .catch((error) => {
              ...
              post === index && (
                ...
                >
                  <div className="p-4 border-b-2 border-slate-300">
                    <input
                      type="file"
                      class="block m-auto text-sm text-slate-500
                  ...
                  <div className="p-4">
                    ...
                    <textarea
                      id="message"
                      rows="6"
                      class="mt-2  px-0 w-full text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
          ...
          <div className="">
            ...
            <div class="mt-6 grid md:grid-cols-3   gap-4">
              <div className="bg-white rounded-lg text-center shadow-sm p-2 hover:shadow-lg ">
                <svg
                  class="sc-hBEYId gsxGRD h-16 w-16 m-auto"
                  viewBox="0 0 61 49"
                >
                  <path
                    opacity="0.3"
