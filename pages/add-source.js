                ...
                <div>
                    ...
                    <div className='bg-white shadow-xl rounded-2xl  '>
                        ...
                        <div className='p-4' >
                            ...
                            <textarea id="message" rows="6" class="mt-2  px-4 w-full text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Your message..."></textarea>
                            <div className='flex justify-between'>
                                <p></p>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
