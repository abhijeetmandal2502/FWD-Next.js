...
const AddSource = () => {
    return (
        <div className=" mb-6  mx-4 md:mx-8 lg:mx-48">
            ...
            <div class="mt-6 grid md:grid-cols-2 sm:grid-cols-1 gap-4 ">
                <div>
                    {/* card */}
                    <div className='bg-white shadow-xl rounded-2xl  '>
                        <div className='p-4 border-b-2 border-slate-300' >
                            <input type="file" class="block m-auto text-sm text-slate-500
                        ...
                        <div className='p-4' >
                            <div className='flex justify-between'>
                                <input type='text' className='font-bold w-full text-2xl ' placeholder='Title of the idea' />
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                </svg>
                            </div>
                            <textarea id="message" rows="6" class="mt-2  px-0 w-full text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Your message..."></textarea>
                            <div className='flex justify-between'>
                                <p></p>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div className=''>
                        ...
                        <div class="mt-6 grid md:grid-cols-3   gap-4">
                            <div className='bg-white rounded-lg text-center shadow-sm p-2 hover:shadow-lg '>
                                <svg class="sc-hBEYId gsxGRD h-16 w-16 m-auto" viewBox="0 0 61 49"  >
                            ...
                            <div className='bg-white rounded-lg text-center shadow-sm p-2 hover:shadow-lg '>
                                <svg class="sc-hBEYId gsxGRD h-16 w-16 m-auto" viewBox="0 0 50 48">
