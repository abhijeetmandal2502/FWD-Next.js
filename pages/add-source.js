...
const AddSource = () => {
  ...
  const removePost = (index) => {
    console.log('checkpostcount', postCount);
  ...
  const onSubmitHandler = async (data) => {
    ...
    if (parentTitle == '' && parentCategory.name == '' && parentContent == '') {
      ...
      if (
        ...
        // categories.unshift(parentCategory.content);
      ...
      for (var i = 0; i < title.length; i++) {
        ...
        // formData.append(`yourSelfTag[${i}]`, categories[i]);
            ...
            {postCount.map((item, index) => {
              return (
                !removeIndex.includes(index) && (
                  <div className="bg-white shadow-xl rounded-2xl  my-3">
                    ...
                    <div className="p-4">
                      ...
                      <div
                        ...
                        onClick={() => {
                          console.log('removeindexcheck', index);
                          // if (index > 1) {
                          removePost(index);
                          // }
                        }}
