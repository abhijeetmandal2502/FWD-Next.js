            ...
            <div className="p-4">
              ...
              <div className="mt-4 flex justify-between   items-center">
                <div className='flex items-center'>
                  <svg id="source-stash-button-1263-stash-dropdown-icon" className="h-5 w-5 mr-2" viewBox="0 0 24 24">
          ...
          <div className='my-10 bg-whitetype  md:rounded-r-xl  relative hover:shadow-2xl shadow-lg'>
            <div className='flex px-4 pb-4 absolute-div' >
              <svg class="sc-hBEYId hucIa w-5" viewBox="0 0 24 24">
                <path d="M18.25 4a.75.75 0 01.75.75v8.5a.75.75 0 01-1.5 0v-8.5a.75.75 0 01.75-.75zM4 18.25a.75.75 0 01.75-.75h8.5a.75.75 0 010 1.5h-8.5a.75.75 0 01-.75-.75zM8.28 7.22a.75.75 0 00-1.06 1.06l6.5 6.5a.75.75 0 101.06-1.06l-6.5-6.5z" fill="currentColor">
                </path>
              </svg>
              <p>Fresh in #psychology</p>
            </div>

            <div className='px-6 py-4'>
              <div className="mt-3 flex  items-center ">
                <img className=" mr-2 inline-block h-8 w-8 rounded-full ring-2 ring-white"
              ...
              <div className="mt-4 flex  items-center  ">
                <div className='p-1  mr-2 bg-white rounded-sm shadow-2xl'>
                  ...
                  <img className="inline-block h-12 w-12 ring-2 ring-white"
                ...
                <div>
                  <h3 className='font-bold'>How Anxiety Gets Out of Control</h3>
                  <div className='flex  items-center'>
              ...
              <div className='flex mt-4 items-center'>
                ...
                <div className='flex items-center'>
                  <div class="flex -space-x-2 overflow-hidden mr-2">
                    <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://deepstash.com/assets/reactions/love.png" alt="" />
                    <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://deepstash.com/assets/reactions/deep.png" alt="" />
                  </div>
                  <p>2 Reactions</p>
                </div>

                <div className='flex items-center ml-4'>
                  <svg class="sc-hBEYId dKDQrr h-6 mr-2" viewBox="0 0 24 24">
                    <path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10a9.96 9.96 0 01-4.587-1.112l-3.826 1.067a1.25 1.25 0 01-1.54-1.54l1.068-3.823A9.96 9.96 0 012 12C2 6.477 6.477 2 12 2zm0 1.5A8.5 8.5 0 003.5 12c0 1.47.373 2.883 1.073 4.137l.15.27-1.112 3.984 3.987-1.112.27.15A8.5 8.5 0 1012 3.5z" fill="currentColor">
                    </path>
                  </svg>
                  <p>Comment</p>
                </div>
